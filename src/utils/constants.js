...
export const activityInput = document.querySelector('.popup__form-activity');

export const addCardButton = document.querySelector('.profile__add-btn');
export const popupAddCard = document.querySelector('.popup_add-card');

export const editFormElement = popup.querySelector('.popup__form');
export const addCardFormElement = popupAddCard.querySelector('.popup__form');
